...
root directory is represented by \ml+'/'+ . The branches are labelled by names (of  
...
(This is the default behaviour of a terminal;
...
the field \ml+in_end+ is therefore initialised to zero.
%
\begin{listingcodefile}{io.ml}
let input_char chan =
...
The behaviour of \ml+lseek+ is unpredictable on certain type of files
