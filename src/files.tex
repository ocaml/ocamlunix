...
\ml+stats+ described in the table~\ref{fig/stats}.
%
\begin{mytable}
...
or change  of the owner, of the group, or the number of links. \smallskip\\
\hline
\end{tabular}
...
(\ml+x+). The permissions on a file result from the union of these
respective permissions, see table~\ref{tab/permbits}.
\begin{mytable}
\begin{tabular}{lcl}
