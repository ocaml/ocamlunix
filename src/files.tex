...
\ml+action+ or \ml+handler+, we immediately stop the traversal and let
...
In examples like \ml+file_copy+, it is not difficult to do input/output
...
To illustrate the buffered \io techniques, we implement a fragment
...
\draw[dashed] (4,3) to node [left,text width=2.5cm,text centered] 
 {written, but buffered, characters} (4,0);
