...
The first argument is the first descriptor and the 
second argument is the position offset specifier. This is interpreted differently 
depending on the value of the third argument, which indicates the 
type of position desired:
%
\begin{mltypecases}
\mltypecase{SEEK\_SET} Absolute position. The second argument is the
...
As for \mltypecase{SEEK\_CUR}, this may be negative as well as positive.
\end{mltypecases}
%
