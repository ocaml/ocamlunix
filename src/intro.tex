...
Leroy teached in 1994 to the first year students of the master in
...
%
For a master course in computer science at the École Polytechnique
...
this course we found it more interesting to use a higer-level
...
polymorphism, higher-horder functions and exceptions. It also shows
that instead of mutally excluding applicative and imperative
programming, their combination makes it possible to integrate in the
...
read section~1 of the Unix \texttt{man}ual or Unix introductory books
like~\cite{KP,R1}.
...
in~\cite{Bach}. Tanenbaum's books~\cite{T1,T2} give an overal view of
network and operating system architecture.

The Unix interface presented in this document is part from the
