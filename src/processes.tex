...
is the return value from \ml+fork+: zero in the child processes,
...
processes.  When a process terminates, it moves into a \quote{zombie}
state, where most, but not all, of is resources (memory, etc.) have
...
leads to the useful \quote{double fork} technique if you cannot
